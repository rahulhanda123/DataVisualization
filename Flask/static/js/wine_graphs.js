...
// load data from a csv file
    d3.csv("winequalityred.csv", function (data) {
        ...
        var pieChart = dc.pieChart("#wine-pie-chart");
        ...
        typeChart.width(480)
            ...
            .ordinalColors(["#ff3232","#ff4c4c","#ff6666","#ff7f7f","#ff9999","#ffcccc"])
        ...
        // workaround for #703: not enough data is accessible through .label() to display percentages
            ...
            .ordinalColors(["#b22323","#ff3232","#ff4c4c","#ff6666","#ff7f7f","#ff9999","#ffcccc","#ffdbdb"])
            .externalLabels(20)
        ...
        monthChart.width(500)
            ...
            .renderlet(function(chart){
                var colors =d3.scale.ordinal().domain(post)
                    ...
                    .range(["#b22323","#ff3232","#ff4c4c","#ff6666","#ff7f7f","#ff9999","#ffcccc","#ffdbdb"]);
                chart.selectAll('rect.bar').each(function(d){
                    d3.select(this).attr("style", "fill: " + colors(d.x));
                });
            })
        ...
        timeChart.width(500)
            ...
            .stack(hourlyComment)
            .transitionDuration(500)
            .ordinalColors(["#000000","#eeba30","#ae0001"])
            .legend(dc.legend().legendText(function(d){
        ...
        heatmap.width(25 * 22.8 + 200)
            ...
            .colors(["#b22323","#ff3232","#ff4c4c","#ff6666","#ff7f7f","#ff9999","#ffcccc","#ffdbdb"])
