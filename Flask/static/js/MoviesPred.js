...
$.getJSON("/moviesdata/predicted", function(data) {
    ...
    var predictedBO = cf.dimension(function(d) {
        return d.predictedBO;
    })
    ...
    var moviesByBoxOffice = predictedBO.group();
...
//Average imdb Rating
    ...
    var stateDonations = dc.barChart("#state-donations-pred");
